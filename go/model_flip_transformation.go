...
// Accepts only nested slice of FlipTransformation (e.g. [][]FlipTransformation), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseFlipTransformationRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aFlipTransformation, ok := obj.(FlipTransformation)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertFlipTransformationRequired(aFlipTransformation)
	})
}
